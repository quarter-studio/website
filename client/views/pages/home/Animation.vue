<script>
  import fs from '@/assets/shaders/noise.fs'
  import vs from '@/assets/shaders/noise.vs'
  import img from '@/assets/images/noise.png'
  ...
  export default {
    mounted () {
      ...
      script.src = 'https://cdn.quarter.studio/scripts/twgl-full.min.js'
...
<template>
  <div class="animation">
    <canvas id="c" ref="canvas" class="shader" width="904" height="1341"/>
    <div class="fader"/>
  </div>
</template>
